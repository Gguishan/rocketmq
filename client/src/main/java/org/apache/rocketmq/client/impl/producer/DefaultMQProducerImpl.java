...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    public void start(final boolean startFactory) throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                // 向MQClientlnstance注册生产者，即将当前生产者添加至MQClientInstance.producerTable中
                // 方便后续调用网络请求、进行心跳检测
    ...
    /**
     * 创建Topic
     * @param key 未实际使用，可与newTopic相同
     * @param newTopic 主题名称
     * @param queueNum  队列数理
     * @param topicSysFlag 主题系统标签
     * @throws MQClientException
     */
    ...
    private SendResult sendDefaultImpl(
        ...
        if (topicPublishInfo != null && topicPublishInfo.ok()) {
            ...
            for (; times < timesTotal; times++) {
                ...
                // 获得一个消息队列，若启动故障延迟策略，可防止排除不可用mp
                MessageQueue mqSelected = this.selectOneMessageQueue(topicPublishInfo, lastBrokerName);
                // 若mqSelected == null，跳出循环
                if (mqSelected != null) {
                    mq = mqSelected;
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        // 若未发现，则尝试通过指定主题topic查找路由信息，并更新路由信息缓存，然后再次获取主节点地址
        if (null == brokerAddr) {
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                // 若是事务prepared消息，设置为MessageSysFlag.TRANSACTION_PREPARED_TYPE
